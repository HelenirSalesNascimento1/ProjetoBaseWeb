...
Funcionalidade: Cadastro
  ...
  Cenario: Verificar atualização dos parametros parceirias campo caledario DE: e ATE:
  ...
  Cenario: Verificar atualização dos parametros parceirias com DE: branco
    E preencho os dados do parceiro
    E clicar no botao continuar
    E preencho os dados de parametros parceirias
  ...
  Cenario: Verificar atualização dos parametros parceirias com ATE: branco
    E preencho os dados do parceiro
    E clicar no botao continuar
    E preencho os dados de parametros parceirias
  ...
  Cenario: Verificar atualização dos parametros parceirias campo caledario, se a data fim deve ser posterior a data inicio
    E preencho os dados do parceiro
    E clicar no botao continuar
    E preencho os dados de parametros parceirias
  ...
  Cenario: Verificar atualização dos parametros parceirias campo caledario, data inicio deve ser posterior a data fim
    E preencho os dados do parceiro
    E clicar no botao continuar
    E preencho os dados de parametros parceirias
    E seleciono campo caledario
  ...
  Cenario: Verificar atualização dos parametros parceirias campo caledario, data corrente pode ser anterior data inicio
    E preencho os dados do parceiro
    E clicar no botao continuar
    E preencho os dados de parametros parceirias
    E seleciono campo caledario
  ...
  Cenario: Verificar atualização dos parametros parceirias campo caledario, data fim deve ser posterior ou igual a data corrente
    E preencho os dados do parceiro
    E clicar no botao continuar
    E preencho os dados de parametros parceirias
    E seleciono campo caledario
  ...
  Cenario: Verificar atualização dos parametros parceirias campo caledario,data corrente deve ser posterior data fim
    E preencho os dados do parceiro
    E clicar no botao continuar
    E preencho os dados de parametros parceirias
    E seleciono campo caledario
